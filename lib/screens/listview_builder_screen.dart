...
class _ListviewBuilderScreenState extends State<ListviewBuilderScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      ...
      print('${scrollController.position.pixels}, ${scrollController.position.maxScrollExtent}, ${imagesIds.last}');
    });
  }



  final List<int> imagesIds = [1,2,3,4,5,6,7,89,10];
                  ...
                  itemCount: imagesIds.length,
                    itemBuilder: (BuildContext context, int index){
                      return FadeInImage(
                        ...
                        image: NetworkImage("https://picsum.photos/500/300/?blur=1?image=${ imagesIds[index] }"),
                      );
                    },
                ),
              ),
